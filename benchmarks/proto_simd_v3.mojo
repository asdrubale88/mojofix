"""Prototype SIMD scanning for HFT parser - V3."""
...
fn main() raises:
    ...
    var size = 10_000_000
    var buf = String(" " * size)
    # Get pointer and cast to mutable logical pointer if needed,
    # but UnsafePointer doesn't track mutability in type usually
    var ptr = buf.unsafe_ptr()

    # Simple write at the end
